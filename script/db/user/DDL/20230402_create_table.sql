...
CREATE TABLE csuserapp.cs_user (
	...
	birthdate         date         null,
	city_of_birth	  varchar(31)  null,
	country_of_birth  varchar(31)  null,
	id_code           varchar(255) null,
	cie_code          varchar(255) null,	
...
COMMENT ON COLUMN csuserapp.cs_user.vat               IS 'Vat value if it is company';
COMMENT ON COLUMN csuserapp.cs_user.nickname          IS 'Nickname value';
COMMENT ON COLUMN csuserapp.cs_user.birthdate         IS 'Birthdate value';
COMMENT ON COLUMN csuserapp.cs_user.city_of_birth     IS 'City of birth value';
COMMENT ON COLUMN csuserapp.cs_user.country_of_birth  IS 'Country of birth value';
COMMENT ON COLUMN csuserapp.cs_user.id_code           IS 'Identity document Code value';
COMMENT ON COLUMN csuserapp.cs_user.cie_code          IS 'Electronic Identity Card (CIE) value';
COMMENT ON COLUMN csuserapp.cs_user.birthdate         IS 'Birthdate value';
